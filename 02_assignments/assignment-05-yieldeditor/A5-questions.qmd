...
These data sets need to be downloaded from the course GitHub page. They are located in the `03-data` as csv files (`yield19.csv` and `yield20.csv`). Copy them from the downloaded GitHub folder and paste into your `data` folder of project `07_yieldmonitor`.  
...
- Deadline is Monday Feb 17th 11:59 pm (we will use all 3 cleaned yield data on our next class period). 
...
After answering all questions, include your last name on the file name (e.g., A5-questions-Bastos.qmd), render it, and submit the .html on eLC by **Monday, Feb 17th 11:59 pm**.  
